...
\section{Version Control Integration (Git)}

Throughout the lifecycle of the Top Score Quiz System, Git was utilized as the primary version control system to manage source code iterations, coordinate deployments, and maintain a robust history of architectural changes. The repository is hosted securely on GitHub.

By leveraging Git, the deployment process is significantly streamlined. Production servers can reliably pull the latest sanitized code directly from the \texttt{main} branch, preventing inconsistencies that arise from manual file transfers.

\begin{figure}[H]
    \centering
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{git1.png}
        \caption{GitHub Repository Overview}
        \label{fig:git1}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{git2.png}
        \caption{Commit History Mapping}
        \label{fig:git2}
    \end{minipage}
\end{figure}
